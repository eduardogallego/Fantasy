...
class StartingTeamParser(HTMLParser):
    ...
    players_dict = {
        ...
        'almeria_Pubill': 'Marc Pubill', 'almeria_Lopy': 'Dion', 'almeria_Montes': 'César Montes',
        ...
        'valencia_Gabriel': 'Gabriel Paulista', 'valencia_Alberto Marí': 'Marí', 'valencia_Cristhian': 'Mosquera',
