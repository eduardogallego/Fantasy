...
class StartingTeamParser(HTMLParser):
    ...
    players_dict = {
        'alaves_Rebbach': 'A. Rebbach', 'alaves_C. Benavidez': 'Benavidez', 'alaves_R. Duarte': 'Duarte',
        ...
        'almeria_Pubill': 'Marc Pubill', 'almeria_Dion': 'Lopy', 'almeria_Montes': 'César Montes',
        'almeria_Viera': 'Jonathan Viera', 'almeria_Romero': 'Luka',
        ...
        'athletic_N. Williams': 'Nico Williams', 'athletic_Unai Gómez': 'Unai G',
        'atletico_M. Llorente': 'Marcos Llorente', 'atletico_Molina': 'Nahuel Molina',
        'atletico_Gabriel': 'Gabriel Paulista',
        ...
        'barcelona_João Félix': 'Joao Félix', 'barcelona_M. Alonso': 'Marcos Alonso', 'barcelona_Koundé': 'Kounde',
        'barcelona_S. Roberto': 'Sergi Roberto', 'barcelona_Balde': 'Álex Balde', 'barcelona_Peña': 'Iñaki Peña',
        'barcelona_Cubarsí': 'Pau Cubarsí', 'barcelona_Araújo': 'Araujo',
        ...
        'betis_Assane': 'Diao', 'betis_Cardoso': 'Johnny', 'betis_Chimy': 'Chimy Ávila',
        ...
        'cadiz_Navarro': 'Robert Navarro', 'cadiz_Kouamé': 'Kouame',
        ...
        'getafe_Iglesias': 'Juan Iglesias', 'getafe_Luis Milla': 'Milla', 'getafe_Moriba': 'Ilaix',
        'girona_Blind': 'Daley Blind', 'girona_Miguel': 'Miguel Gutiérrez', 'girona_Savinho': 'Sávio',
        'girona_Herrera': 'Yangel Herrera', 'girona_Arnau Mtnez.': 'Arnau', 'girona_Kébé': 'Ibrahima Kebé',
        'girona_Solís': 'Jhon Solis',
        'granada_Adri López': 'Adri Lopez', 'granada_Callejón': 'Callejon', 'granada_F. Diédhiou': 'Diedhiou',
        'granada_Villar': 'Gonzalo Villar', 'granada_Miquel': 'Miki Bosch', 'granada_Raúl F.': 'Raúl F',
        'granada_Ferreira': 'André F.', 'granada_Puertas': 'Antonio Puertas', 'granada_I. Miquel': 'Miquel',
        'granada_Bruno Méndez': 'Méndez',
        'las-palmas_Alex Suárez': 'Álex Suárez', 'las-palmas_J. Araujo': 'Araujo',
        ...
        'las-palmas_E. Curbelo': 'Curbelo', 'las-palmas_Iñaki González': 'Iñaki', 'las-palmas_Muñoz': 'Javi Muñoz',
        'las-palmas_Á. Lemos': 'Lemos S', 'las-palmas_Perrone': 'Máximo Perrone', 'las-palmas_Vallés': 'Valles',
        'las-palmas_Cristian H.': 'Herrera', 'las-palmas_Benito': 'Benito J',
        ...
        'mallorca_Samú': 'Samu Costa', 'mallorca_Javi Llabrés': 'Llabrés',
        'osasuna_Rubén G.': 'Rubén García', 'osasuna_Oroz': 'Aimar Oroz', 'osasuna_Aitor Fdez.': 'Aitor Fdez',
        'osasuna_Ibáñez': 'Ibañez', 'osasuna_Muñoz': 'Iker Muñoz', 'osasuna_Raúl García': 'Raúl',
        ...
        'real-sociedad_Ali Cho': 'Momo Cho', 'real-sociedad_Marín': 'Pablo Marín', 'real-sociedad_Galán': 'Javi Galán',
        ...
        'sevilla_Ramos': 'Sergio Ramos', 'sevilla_Romero': 'Isaac',
        'valencia_Javi Guerra': 'Guerra', 'valencia_Duro': 'Hugo Duro', 'valencia_Gayà': 'Gayá',
        'valencia_Alberto Marí': 'Marí', 'valencia_Cristhian': 'Mosquera',
        'valencia_Yaremchuk': 'Roman Yaremchuk', 'valencia_Thierry': 'Thierry Correia', 'valencia_Özkacar': 'Cenk',
        'valencia_Hugo González': 'González', 'valencia_Jaume': 'Jaume Domenech',
